...
class BookManagementPage extends StatelessWidget {
  ...
  Widget _buildHeader(BookController controller, {required bool isMobile}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Page Header Title
        ...
        // Responsive Two-Tier Action Bar (Top Tier: Search & Primary Actions)
        if (isMobile) ...[
          SizedBox(
            height: 44,
            child: Container(
  ...
  Widget _buildFilters(BookController controller, {required bool isMobile}) {
    return Wrap(
      spacing: 12.0,
      runSpacing: 12.0,
  ...
  Widget _buildContentList(BuildContext context, BookController controller, {required bool isMobileScroll}) {
    return Obx(() {
