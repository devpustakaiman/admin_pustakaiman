...
class CategoryManagementPage extends StatelessWidget {
      ...
      return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              _buildHeader(context, controller, isMobile: true),
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildHeader(context, controller, isMobile: false),
            const SizedBox(height: 24),
            Expanded(
  ...
  Widget _buildHeader(BuildContext context, CategoryController controller, {required bool isMobile}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Column(
  ...
  Widget _buildContentList(BuildContext context, CategoryController controller, {required bool isMobileScroll}) {
    final isMobile = MediaQuery.of(context).size.width < 768;
    return Obx(() {
                                            ...
                                            Row(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  child: const Icon(LucideIcons.folder, color: AppTheme.primaryColor, size: 18),
                                                ),
